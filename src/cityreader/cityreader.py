...
def cityreader(cities=[]):
  ...
  with open('cities.csv', newline='') as csvfile:
    ...
    next(csv_file)
    for row in csv_file:
      cities.append(City(name=row[0],lat=row[3],lng=row[4]))
    return cities
...
def cityreader_stretch(lat1, lon1, lat2, lon2, cities=cities):
  ...
  #NOTE LONGITUDES ARE NEGATIVE IN THE WESTERN HEMISPHERE, "GREATER THAN" IS RELATIVE
  ...
  #input sanitation of floats is done at the class level no need to verify here.
